...
$(document).ready(function(){
  ...
  var fieldHTML = '<div><input type="email" name="dynfields[]" value="" placeholder="Please enter email id" required/><input type="hidden" name="unique" value="$invono"><a href="javascript:void(0);" class="remove_button" title="Remove field"><img src="assets/images/remove-icon.png"/></a></div>'; //New input field html 
